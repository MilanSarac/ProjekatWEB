	...
	<div>
		<ul class="nav nav-pills">
			<li class="nav-item"><a class="nav-link  active" href="user.jsp">Korisnicki
					podaci</a></li>
			<li class="nav-item"><a class="nav-link" href="location.jsp">Dodavanje Lokacije
					A</a></li>
			...
			<li class="nav-item"><a class="nav-link"
				href="allUsers.jsp">Svi korisnici</a></li>
			...
			<form action="/WebProjekat/updateUser.jsp"  method="post">
				<div class="form-group">
					<label for="Name">Name</label> <input type="text"
						class="form-control" name="Name" value="<c:out value="${result.Name}" />">

				</div>
				<div class="form-group">
					<label for="login-password">SureName</label> <input type="text"
						class="form-control" name="SureName" value="<c:out value="${result.SureName}" />">
				</div>
				<div class="form-group">
					<label for="login-password">Password</label> <input type="text"
						class="form-control" name="Password" value="<c:out value="${result.Password}" />">
				</div>
