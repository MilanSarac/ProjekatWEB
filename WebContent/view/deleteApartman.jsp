...
<body>
	...
	<form method="post" >
	<div>
	<input type="hidden"  name="ID_Apartman" value="<%=session.getAttribute("iD_Apartman1") %>"></div>
	<div><input type="hidden"  name="Id11" value="<c:out value="${iD_Apartman1}" />"></div>
	
	</form>
	</div>
<%=session.getAttribute("ID_Apartman") %>	
</body>
</html>